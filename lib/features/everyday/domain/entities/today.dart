...
class Today extends Equatable {
  ...
  // @override // TODO: implement stringify
  // bool? get stringify => super.stringify;
  @override
  String toString() {
    return 'Today(id: $id, caption: $caption, localVideoPath: $localVideoPath, remoteVideoUrl: $remoteVideoUrl, date: $date, localThumbnailPath: $localThumbnailPath, remoteThumbnailUrl: $remoteThumbnailUrl)';
  }
}
